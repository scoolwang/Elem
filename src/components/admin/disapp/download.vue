    ...
    <div class="write-content">
      ...
      <el-table :data="tableData">
        ...
        <el-table-column prop="size" label="文件大小">
          <div slot-scope="scope">
            <span class="content">{{ scope.row.size }}M</span>
          </div>
        </el-table-column>
        <el-table-column prop="use_points" label="扣点">
        </el-table-column>
        <el-table-column prop="platform" label="平台">
        </el-table-column>
        <el-table-column prop="browser" label="浏览器">
        </el-table-column>
        <el-table-column prop="update_at" label="下载时间" width="170">
        </el-table-column>
        <el-table-column prop="update_ip" label="下载IP" width="170">
        </el-table-column>
      </el-table>
...
/* eslint-disable */
  ...
  export default {
    ...
    methods: {
      ...
      requestList (page) {
        api.post('disapp/version/downloadrecord', {
          page: page
        }, (res) => {
          if (res.status === 200) {
            const data = res.data
